 ...
 * プログラムが実行されたら、なんらかの方法でデータファイルを読み込み、データファイル内にある「オムライス」というレシピ情報をロードして、そのレシピ情報を出力する。
 ...
 * グループの他の人がREADME.txtに従って、ファイルを作成してプログラムにレシピ情報をロードできる。
 ...
 * グループの他の人がREADME.txtに従って、レシピIDを指定できる。
 ...
 * グループの他の人がREADME.txtに従って、説明文を関連付けたデータファイルを作成できる。
 ...
 * グループの他の人がREADME.txtに従って、レシピ情報にユーザー名を関連付けられる。
 ...
 * グループの他の人がREADME.txtに従って、各レシピ情報に各ユーザー名を関連付けられる。
